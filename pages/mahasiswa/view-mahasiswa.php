...
<?php if ($mahasiswa) : ?>
    <?php
    $tanggalLahir = !empty($mahasiswa['tanggal_lahir']) ? date('d/m/Y', strtotime($mahasiswa['tanggal_lahir'])) : '-';
    ?>
    <style>
        .detail-card {
            border-radius: 14px;
                ...
                <div class="detail-head">
                    <div class="detail-brand">
                        ...
                        <div>
                            ...
                            <h5 class="title mb-0"><?php echo htmlspecialchars($mahasiswa['nama']); ?></h5>
                            <div class="subtitle">NIM: <?php echo htmlspecialchars($mahasiswa['nim']); ?></div>
                        </div>
                    </div>
                    <div class="detail-chip">Mahasiswa</div>
                </div>
                <div class="detail-body">
                    <div class="detail-grid">
                        <div class="detail-item">
                            <span class="detail-label">NIM</span>
                            <span class="detail-value"><?php echo htmlspecialchars($mahasiswa['nim']); ?></span>
                        </div>
                        <div class="detail-item">
                            <span class="detail-label">Tempat, Tgl Lahir</span>
                            <span class="detail-value">
                                <?php echo htmlspecialchars(trim(($mahasiswa['tempat_lahir'] ?? '') . ($tanggalLahir !== '-' ? ', ' . $tanggalLahir : '')) ?: '-'); ?>
                            </span>
                        </div>
                        <div class="detail-item">
                            <span class="detail-label">Jenis Kelamin</span>
                            <span class="detail-value"><?php echo htmlspecialchars($mahasiswa['jenis_kelamin']); ?></span>
                        </div>
                        <div class="detail-item">
                            <span class="detail-label">Jurusan</span>
                            <span class="detail-value"><?php echo htmlspecialchars($mahasiswa['jurusan']); ?></span>
                        </div>
                        <div class="detail-item">
                            <span class="detail-label">Tahun Masuk</span>
                            <span class="detail-value"><?php echo htmlspecialchars($mahasiswa['tahun_masuk']); ?></span>
                        </div>
                        <div class="detail-item">
                            <span class="detail-label">Status</span>
                            <span class="detail-value"><?php echo htmlspecialchars($mahasiswa['status']); ?></span>
                        </div>
                        <div class="detail-item">
                            <span class="detail-label">Email</span>
                            <span class="detail-value"><?php echo htmlspecialchars($mahasiswa['email'] ?? '-'); ?></span>
                        </div>
                        <div class="detail-item">
                            <span class="detail-label">No HP</span>
                            <span class="detail-value"><?php echo htmlspecialchars($mahasiswa['no_hp'] ?? '-'); ?></span>
                        </div>
                        <div class="detail-item" style="grid-column: span 2;">
                            <span class="detail-label">Alamat</span>
                            <span class="detail-value"><?php echo htmlspecialchars($mahasiswa['alamat'] ?? '-'); ?></span>
                        </div>
                    </div>
                </div>
            </div>
