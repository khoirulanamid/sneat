...
try {
    ...
    // Pastikan tiap mahasiswa hanya punya 1 KTM
    $cekKtmMahasiswa = $pdo->prepare("SELECT COUNT(*) FROM ktm WHERE id_mahasiswa = :id");
    $cekKtmMahasiswa->execute([':id' => $idMahasiswa]);
