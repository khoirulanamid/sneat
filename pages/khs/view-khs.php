                ...
                <div class="detail-body">
                    <div class="detail-grid mb-2">
                        ...
                        <div class="detail-item">
                            ...
                            <span class="detail-value"><?php echo htmlspecialchars(number_format((float)$data['nilai_angka'], 2)); ?></span>
                        </div>
                        <div class="detail-item">
                            <span class="detail-label">Nilai Huruf</span>
                            <span class="detail-value"><?php echo htmlspecialchars($data['nilai_huruf']); ?></span>
                        </div>
                        <div class="detail-item">
                    ...
                    <div class="detail-item mb-2">
                        ...
                        <span class="detail-value"><?php echo htmlspecialchars($data['catatan'] ?? '-'); ?></span>
                    </div>
                    <div class="detail-item">
