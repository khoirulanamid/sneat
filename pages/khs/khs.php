                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    <form method="POST" action="<?php echo page_url('khs/delete-khs'); ?>" class="d-inline" onsubmit="return confirm('Yakin hapus data ini?');">
                                        <input type="hidden" name="id" value="<?php echo htmlspecialchars($khs['id_khs']); ?>">
